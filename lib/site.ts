...
export const services = [
  ...
  },
  {
    ...
    description:
      "Scheduled follow-up visits under our 12-month service warranty until you are bed bug free.",
    icon: "shield",
  },
];
...
export const processSteps = [
  ...
  },
  {
    ...
    description:
      "After treatment we monitor the space and schedule follow-up visits to confirm complete elimination under our 12-month warranty.",
  },
  {
    step: "04",

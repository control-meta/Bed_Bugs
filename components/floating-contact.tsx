  ...
  return (
    <div className="fixed bottom-4 right-4 z-40 flex items-center gap-2 rounded-full border border-ink/10 bg-white/90 p-2 shadow-[0_18px_45px_-12px_rgba(23,6,9,0.35)] backdrop-blur-xl sm:bottom-7 sm:right-7 sm:gap-2.5 sm:p-2.5">
      <a
        ...
        className="group relative flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-br from-[#2fe476] to-[#17a94a] text-white shadow-lg shadow-[#22c55e]/30 ring-1 ring-inset ring-white/25 transition-all duration-200 hover:scale-105 hover:shadow-[#22c55e]/50 sm:h-12 sm:w-12"
      >
        <WhatsAppIcon className="h-6 w-6 drop-shadow" />

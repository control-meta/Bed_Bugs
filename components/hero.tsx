    ...
    >
      ...
      <div className="hero-fluid relative z-20 mx-auto flex w-full max-w-7xl flex-1 flex-col justify-center px-4 pb-[3em] pt-[max(5.5rem,7em)] sm:px-6 lg:px-8 lg:pb-[1.5em] lg:pt-[7.5em]">
        <div className="flex max-w-[45em] flex-col gap-[1.05em] lg:-translate-y-[2em]">
          ...
          <h1 className="font-display text-[2.4em] font-extrabold leading-[1.06] tracking-tight text-white sm:text-[2.9em] lg:text-[3.4em]">
            Bed Bugs?
          ...
          <p className="max-w-[33em] text-[1.05em] leading-relaxed text-white/75">
            Safe, effective and long-lasting bed bug treatment for homes,
            apartments, hotels and businesses. Sleep peacefully again.
          </p>

          <div className="flex max-w-[46em] flex-wrap gap-x-[1.8em] gap-y-[0.9em] max-sm:grid max-sm:grid-cols-2 max-sm:gap-x-[1.2em]">
            {features.map((feature) => (
              <div key={feature.title} className="flex items-center gap-[0.7em]">
                <span className="flex h-[2.6em] w-[2.6em] shrink-0 items-center justify-center rounded-full border border-brand-500/50 bg-brand-600/10">
                  <feature.icon className="h-[1.3em] w-[1.3em] text-brand-400" />
                </span>
                <span className="text-[0.92em] font-medium leading-tight text-white/90">
                  {feature.title}
          ...
          <div className="flex flex-col gap-[0.9em] sm:flex-row sm:items-center">
            <Link
              href="/contact"
              className="group inline-flex items-center justify-center gap-[0.7em] rounded-full bg-brand-600 px-[1.8em] py-[0.95em] text-[0.92em] font-semibold text-white shadow-xl shadow-brand-600/40 transition hover:bg-brand-500"
            >
            ...
            <a
              ...
              className="inline-flex items-center justify-center gap-[0.7em] rounded-full border border-white/30 px-[1.8em] py-[0.95em] text-[0.92em] font-semibold text-white transition hover:border-white/70 hover:bg-white/10"
            >
        ...
        <div className="relative mt-[1.8em] lg:hidden">

...
export function ProcessSection() {
  return (
    <section
      id="process"
      className="relative scroll-mt-20 overflow-hidden bg-ink py-12 lg:py-16"
    >
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mt-10">
          <div
            className="absolute left-0 right-0 top-[22px] hidden h-px bg-gradient-to-r from-transparent via-brand-600/60 to-transparent lg:block"
            aria-hidden
          />
            ...
            {processSteps.map((step, index) => {
              ...
              return (
                <div key={step.step} className="relative text-center">
                  <div className="relative z-10 mx-auto flex h-11 w-11 items-center justify-center rounded-2xl bg-brand-600 text-white shadow-lg shadow-brand-600/40">
                    <Icon className="h-5 w-5" />
                  </div>
                  <p className="mt-4 font-display text-[11px] font-bold uppercase tracking-[0.2em] text-brand-400">
                    Step {step.step}
                  </p>
